        ...
        <div class="row">
          {jobs_list.map((item, index) => (
            <div class="col-md-3" key={index}>
              <Card style={{ width: '19rem', height: '15rem' }} class="card mb-3">
                <Card.Body>
                  <Card.Title style={{ color: "black", fontSize: "bold" }}>{item.title}</Card.Title>
                  <Card.Text style={{ height: 120 }} class="mt-3">{item.text}</Card.Text>
